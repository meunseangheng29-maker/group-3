...
// Store favorite drink IDs
const favorites = ref<number[]>([])

// Check if a drink is favorite
const isFavorite = (drinkId: number) => {
  return favorites.value.includes(drinkId)
}

// Add / remove favorite
const toggleFavorite = (drinkId: number) => {
...
const filteredDrinks = computed(() => {
  if (selectedCategory.value === 'All Drinks') {
    return drinks
  }
      ...
      <div class="hero-content">
        ...
        <div class="hero-buttons">
          ...
          <button
            class="favorite-btn"
            :class="{
              favorite: isFavorite(todayDrink.id)
            }"
            @click="toggleFavorite(todayDrink.id)"
          >
            <Heart
              :size="22"
              :fill="
                isFavorite(todayDrink.id)
                  ? 'currentColor'
                  : 'none'
              "
            />
