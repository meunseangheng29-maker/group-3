  ...
  <div class="checkout-container"> 
    ...
    <div v-if="showSuccessModal" class="modal-overlay">
      <div class="success-modal-card">
        ...
        <p>Thank you for your purchase. Your order has been sent to the admin successfully.</p>
        <button class="modal-home-btn" @click="closeModalAndRedirect">
          Back to Home
        </button>
      </div>
    </div>
...
function handlePlaceOrder() { 
  ...
  const newOrder = { 
    ...
    name: form.fullName, // រក្សាទុកជាមួយ key 'name' ស្របគ្នាជាមួយ adminCustomer page
    phone: form.phone, 
  ...
  // បង្ហាញ Success Popup ជំនួសឱ្យ alert()
